...
<body>
<div class="container" style="height: 750px; padding-top: 100px;">
<form:form action="step3.wow" modelAttribute="member" method="post">
<div class="row col-md-8 col-md-offset-2" style="margin: auto; background: #fff; border: 1px solid #ddd; margin-top: 80px;">
	<div class="page-header">
		<h3 style="margin-top: 10px;">회원가입 2단계</h3>
	</div>
	...
	<table class="table" >
		...
		<tr>
			...
			<td>
				...
				<button type="button" onclick="fn_idCheck()" style="background: black; color: #fff; border-radius: 5px;">중복확인</button>
		...
		<tr class="form-group-sm">
			...
			<td>
				...
				<button type="button" onclick="fn_emailCheck()" style="background: black; color: #fff; border-radius: 5px;">이메일인증</button>
		...
		<tr>
			<td colspan="2" align="right">
					...
					<button type="submit" class="btn primary" style="background: black; color: white; border: black; height: 35px;" id="next">
...
$(document).ready(function (e) {
	$("button[type='submit']").on("click", function (e) {
		...
		if (idCheckYn === "Y"){
			 alert("아이디 증복 확인")
		} else 	if(myRandomKey == null || myRandomKey === ''){
			alert("이메일 인증이 필요합니다.");
		} else if(myRandomKey === randomKey ){
			alert("인증되었습니다");
			$("form").submit();
		} else {
			alert("이메일 인증키가 다릅니다");
