...
<body>
	...
	<div class="container">
		...
		<div class="row col-md-8 col-md-offset-2" style="margin: auto; background: #fff; border: 1px solid #ddd; margin-top: 150px;">
			<div class="page-header">
				<h3 style="margin-top: 10px; padding-bottom: 10px; border-bottom: solid;">회원가입 3단계</h3>
			</div>
			...
			<table class="table">
				...
				<tr class="form-group-sm">
					<th>주소</th>
					<td>
					<button type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" style="background: black; color: #fff; border-radius: 5px; margin-bottom: 5px;">우편번호 찾기</button>
...
<%-- 					<td colspan="2">
						<div class="pull-left" style="text-align: right;">
							<a href="${pageContext.request.contextPath}/join/cancel" class="btn btn-primary" style="background: black; color: white; border: black; height: 30px;"> <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> 취 소
							</a>
						</div>
						<div class="pull-right" style="text-align: right;">
							<button type="submit" class="btn btn-sm primary" style="background: black; color: white; border: black; height: 30px;">
								<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> 다 음
							</button>
						</div>
					</td> --%>
					<td colspan="2" align="right">
						<a href="cancel" class="btn btn-primary" style="background: #a40000; color: white; border: #a40000; height: 35px; margin-right: 5px;">
							<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
							취 소
						</a>
						<button type="submit" class="btn primary" style="background: black; color: white; border: black; height: 35px;">
