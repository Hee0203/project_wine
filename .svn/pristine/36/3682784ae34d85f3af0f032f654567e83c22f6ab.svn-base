...
<body>
      ...
      <div class="container">
		...
		<div class="section-title" data-aos="zoom-in">
			<c:if test="${USER_INFO.userId != null}">
      			<h2>Recommend</h2>
				<h3><span style="color:black;">Recommend Wine For You</span></h3>
    ...
    <section id="news" class="faq">
      <div class="container">
        ...
        <div class="section-title" data-aos="zoom-in">
          <h2>news</h2>
          <h3><span style="color:black;">WINE NEWS </span></h3>
          <p> </p>
        </div>
    ...
    <section id="community" class="faq">
      <div class="container">
        ...
        <div class="section-title" data-aos="zoom-in">
          <h2>Community</h2>
          <h3><a href="../comm/commList.wow"><span style="color:black;">COMMUNITY</span></a></h3>
          <p> </p>
        </div>
		...
		success:function(data){
			...
			$.each(data.data, function(i,e){
	            ...
	            '<div class="box" data-aos="zoom-in" data-aos-delay="200">'+
              	...
              	'<li style="padding-bottom:5px;"><a class="wineEn">'+e.wineEn+'</a></li>'+
              	'<li><a class="wineKo">'+e.wineKo+'</a></li>'+
	              '</ul>'+ 
		              '<div class="btn-wrap" style="margin-top:30px;"><a href="<%=request.getContextPath()%>/wine/wineView.wow?wineNo='+e.wineNo+'" class="btn-buy">더보기</a>'+
	              '</div></div></div>';
				console.log(str);
		...
		success:function(data){
			...
			$.each(data.data, function(i,e){
	            ...
	            '<div class="box" data-aos="zoom-in" data-aos-delay="200">'+
	              '<h3>추천 '+[i+1]+'</h3><ul><li><img class="wine_img" src='+e.wineImg+'></li>'+
              	'<li style="padding-bottom:5px;"><a class="wineEn">'+e.wineEn+'</a></li>'+
              	'<li style-"margin-top:30px;"><a class="wineKo">'+e.wineKo+'</a></li>'+
	              '</ul>'+ 
